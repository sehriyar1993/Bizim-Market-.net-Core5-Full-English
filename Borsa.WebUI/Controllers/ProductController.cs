...
namespace Borsa.WebUI.Controllers
{
	...
	public class ProductController : Controller
    {
        ...
        {
            //IList<SelectListItem> value = (from x in caTGetList()
        ...
        public IActionResult Updae(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        [HttpPost]
        public async Task<IActionResult> Updae(ProductModel model, int[] categoryIds, IFormFile file)
        {
            if (ModelState.IsValid)
            {
                var entity = _productService.GetById(model.Id);
